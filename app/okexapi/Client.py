...
def getkline():
    ...
    print("kline")
    kline = okcoinSpot.kline('btc_usd', '1day')
    # for line in kline:
    #     print('timestamp:{0},open:{1},high:{2},low:{3},close:{4}'.format(
    #         time.strftime('%Y-%m-%d', time.localtime(line[0] / 1000)),
    #         # line[0],
...
# for tic in ticker:
#     print tic, ticker[tic]
# print (u' 现货深度 ')
# # print (okcoinSpot.depth('btc_usd'))
# depth = okcoinSpot.depth('btc_usd')
# for dep in depth:
#     print dep, depth[dep]
